...
const CategoryContainerOfSideBar = ({filterByCategory,setFilterByCategory}) => {
    ...
    return (
        ...
        <ul onClick={clickHandler}  className='relative z-50 h-28 w-[80%] right-[10%] top-0 flex-col items-center sm:top-[9svh] flex  sm:w-48 sm:gap-1 sm:right-6 sm:h-[42svh] overflow-hidden'>
